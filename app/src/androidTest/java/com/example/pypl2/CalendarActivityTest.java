...
public class CalendarActivityTest {
    ...
    public void calendarActivityTest() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.etTest),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("paypal android"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tvTeest), withText("paypal android"),
                        withParent(allOf(withId(R.id.main),
                                withParent(withId(android.R.id.content)))),
                        isDisplayed()));
        textView.check(matches(withText("paypal android")));
    }
